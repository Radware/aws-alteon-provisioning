{
  ...
  "RawConfig": {
    ...
    "ConfigArray": [
      ...
      "/c/l3/if 2/ena/ipver v4/addr ${adc_servers_private_ip1}/mask 255.255.255.0/vlan 2",
      "/c/slb/pip/add ${adc_servers_private_ip2} 2",
      "/c/l3/gw 1/ena/ipver v4/addr ${data_subnet_gateway}",
      "/c/l3/gw 2/ena/ipver v4/addr ${servers_subnet_gateway}",
